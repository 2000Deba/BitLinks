...
export default function ShortenPage() {
  ...
  const handleAliasChange = (e) => {
    ...
    const deleteLink = (shortUrl) => {
        const filtered = results.filter((item) => item.shortUrl !== shortUrl);
        setResults(filtered);
            ...
            <div className="max-w-3xl mx-auto text-center">
                ...
                <motion.form
                    ...
                    <div className="pointer-events-none absolute inset-0 rounded-2xl opacity-70">
                        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r bg-gradient-to-r from-green-500 via-yellow-500 via-orange-500 via-pink-500 to-purple-500 blur-2xl animate-pulse" />
                    </div>
                    ...
                    <div className="text-left">
                        ...
                        <input
                            id="alias"
                            className="mt-2 w-full px-4 py-3 rounded-xl border border-gray-200 bg-white/90 outline-none 
                       focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300
                       hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:bg-white/70 backdrop-blur-md"
                            type="text"
              ...
              <div className="mt-1 text-xs text-gray-500">
                You can use letters, numbers, dash (-), underscore (_), dot (.), and at (@).
              </div>
            )}
                    </div>
